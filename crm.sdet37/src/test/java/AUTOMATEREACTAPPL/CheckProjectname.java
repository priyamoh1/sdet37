...
public class CheckProjectname {
	...
	public static void main(String[] args) throws SQLException, InterruptedException, AWTException, IOException
	{
		...
		String projectname="TY_PROJECT19";
		...
		try 
		{
			...
			while(set.next())
			{
				String allprojects=set.getString(4);
