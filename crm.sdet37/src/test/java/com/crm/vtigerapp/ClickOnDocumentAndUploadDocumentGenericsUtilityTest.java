...
public class ClickOnDocumentAndUploadDocumentGenericsUtilityTest
{
...
//		driver.manage().window().maximize();
		...
		driver.findElement(By.xpath("//td[@id=\"cke_contents_notecontent\"]")).sendKeys("these are ver important documents");
